...
define('USERNAME', sizeof($argv) >= 3 ? $argv[1] : 'icapillo@istsanpablo.edu.pe');
define('PASSWORD', sizeof($argv) >= 3 ? $argv[2] : 'Atenas#2021');

// Fill your data:
define('FROM', 'IST San Pablo'); // Sender name/address
define('TO', '+51972631040'); // Receiver address
define('NOTIFY_URL', '');

...
// 🚀 1. CONFIGURACIÓN DE RUTAS DEL BUCKET (Maestras para todo el reporte)
...
$url_lavado        = $url_base . "lavado/";        // Foto de Salida

// 2. CONSULTA PRINCIPAL (Cita, Vehículo, Cliente y Orden)
    ...
    <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-white">
        <div class="card-header bg-dark p-4 p-md-5 border-0 text-white">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end mt-3">
                    <span class="badge bg-primary rounded-pill px-3 py-2 text-uppercase"><?php echo $d['estado_orden'] ?? 'EN PROCESO'; ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-4 p-md-5">
            <div class="row mb-5 g-3 border-bottom pb-4">
                ...
                <div class="col-md-3">
                    <small class="text-muted text-uppercase fw-bold d-block mb-1" style="font-size: 10px;">KM / Combustible</small>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center p-2 border rounded-3 bg-light-subtle">
                                    ...
                                    <span class="small text-muted flex-grow-1 text-uppercase" style="font-size: 10px;"><?php echo str_replace('_', ' ', $c['item_nombre']); ?></span>
                                ...
                                <div class="card border-0 shadow-sm rounded-4 h-100 bg-white border border-light-subtle overflow-hidden">
                                    <div class="p-3">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            ...
                                            <?php $bc = ($ir['estado'] == 'OK') ? 'bg-success' : (($ir['estado'] == 'REGULAR') ? 'bg-warning text-dark' : 'bg-danger'); ?>
                                            <span class="badge <?php echo $bc; ?> rounded-pill px-2 py-1" style="font-size: 8px;"><?php echo $ir['estado']; ?></span>
                                        </div>
                                        <?php if($ir['foto_evidencia']): ?>
                                            <div class="rounded-3 overflow-hidden mt-2 position-relative shadow-sm" style="height: 100px;">
                                                <img src="<?php echo $url_evidencias . trim($ir['foto_evidencia']); ?>" class="w-100 h-100 object-fit-cover">
                                            </div>
                                        <?php else: ?>
                                ...
                                <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100 bg-white border border-light-subtle">
                                    <div class="position-relative" style="height: 160px;">
                                        ...
                                        <div class="position-absolute top-0 end-0 m-2">
                                            <span class="badge bg-success shadow-sm rounded-pill" style="font-size: 8px;">FINALIZADO</span>
                                        </div>
                                    </div>
                                    <div class="card-body p-3">
                                        <p class="mb-0 fw-bold text-dark small" style="line-height: 1.2;"><?php echo $ev['descripcion']; ?></p>
                                    </div>
                                </div>
                            </div>
                            <?php endwhile; ?>
